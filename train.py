            ...
            rows.append(
                {
                    ...
                    "clip_frame_count": _clip_frame_count(env, clip_id),
                    "clip_motion_length_s": _clip_motion_length(env, clip_id),
                    "clip_source_start_frame": _clip_source_start_frame(env, clip_id),
                    "clip_source_end_frame": _clip_source_end_frame(env, clip_id),
